      ...
      <span slot="operation" slot-scope="record">
        ...
        <a-modal v-model="roomVisible" title="编辑房间" @ok="roomOk">
          <a-row type="flex" align="middle">
            ...
            <a-col :span="14"> {{ rowRecord.area }} </a-col>
          </a-row>
          ...
          <a-row type="flex" align="middle">
            ...
            <a-col :span="14"> <a-input style="width: 100%" v-model="rowRecord.roomNum" allowClear></a-input> </a-col>
          </a-row>
        ...
        <a-modal v-model="personVisible" title="人员变更" @ok="personOk">
          ...
          <a-row type="flex" align="middle">
            <a-col :span="4">房间号：</a-col>
            <a-col :span="14"> {{ rowRecord.roomNum }} </a-col>
          </a-row>
