<template>
    <div>
        <a-card>
            ...
            <span>事件类型：</span>
            <a-select style="width: 13%" placeholder="请选择事件类型" @change="typeChange1" allowClear>
...
const columns = [
    ...
    { title: '角色类型', dataIndex: 'type', key: 'type', width: '15%' },
    { title: '事件类型', dataIndex: 'thingtype', key: 'thingtype', width: '15%' },
