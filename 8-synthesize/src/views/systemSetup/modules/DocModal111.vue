    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="文档类型" hasFeedback>
          <a-input style="width:200px" v-model="modalForm.docType" placeholder="请输入文档类型" />
        </a-form-item>
  ...
  data() {
    return {
      ...
      changeData_: {
        ...
        set(val) {
          this.$emit('on-change-changeData', val)
        }
      }
  ...
  methods: {
    ...
    handleOk() {
      ...
      if (this.docType != '') {
        const newData = {
          key: this.count,
          docType: this.modalForm.docType,
          value: 1,
        }
        console.log(newData)
        this.changeData_ = [...this.dataParent, newData]
