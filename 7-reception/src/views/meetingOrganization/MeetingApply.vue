          ...
          <tbody>
            <tr>
              <td colspan="2">
                ...
                <div class="bgc">
                  <a-select id="meetingTheme" :default-value="meetingTheme" :style="{width:'80%'}"  @change="handleChange">
              ...
              <td>
                ...
                <div class="bgc">
                  <a-input id="meetingName" placeholder="请输入会议名称" :style="{width:'80%'}" :value="meetingName"></a-input>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                ...
                <div class="bgc">
                  <a-input id="responsibleName" placeholder="请输入负责人姓名" :style="{width:'80%'}" :value="responsibleName"></a-input>
                </div>
              </td>
              <td>
                <label for="responsibleTelphone"  :style="{marginLeft:'20px'}">负责人电话</label>
                <div class="bgc">
                  <a-input id="responsibleTelphone" placeholder="请输入负责电话" :style="{width:'80%'}" :value="responsibleTelphone"></a-input>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2">
                ...
                <div class="bgc">
                  <a-input id="meetingAddress" placeholder="请输入会议地点" :style="{width:'80%'}" :value="meetingAddress"></a-input>
                </div>
              </td>
              <td colspan="2">
                <label for="meetingBarget"  :style="{marginLeft:'20px'}">会议预算</label>
                <div class="bgc">
                  <a-input id="meetingBarget" placeholder="请输入会议预算" :style="{width:'80%'}" :value="meetingBarget" type="number"></a-input> 元
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="3" style="text-align:center">
                <a-button @click="submitApply" shape="round" size="large" :style="{ width: '300px', background: '#77acf1', color: 'white', marginRight: '20PX'}" >
                提交申请
                </a-button>
                <a-button shape="round" size="large" :style="{ width: '300px', background: '#77acf1', color: 'white' }" >
                  保存草稿
                </a-button>
              </td>
            </tr>
