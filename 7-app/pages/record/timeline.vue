<template>
	<view>
		<cu-custom bgColor="bg-gradual-blue" :isBack="true"><block slot="backText">返回</block><block slot="content">时间轴</block></cu-custom>
		<view class="cu-timeline">
			...
			<view class="cu-item text-blue">
				<view class="bg-blue content">
					...
					XX会议记录2
					<view class="margin-top">出售烟草战略3
					</view>
				</view>
				<view class="bg-cyan content">
					<text>2021-06-08</text>
					XX会议记录3
				</view>
			</view>
		</view>
