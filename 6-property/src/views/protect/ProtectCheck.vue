<template>
    <div class="">
        <PageTemplate :columns="columns" :searchCon="searchCon" :formdata="data">
            <a-button type="primary" @click="checkAll">一键通过核查</a-button>
            ...
            >
                <span slot="action" slot-scope="text, record">
                    <template v-for="(i, index) in record.action">
                        ...
                        <template v-else>
                            <component :is="i.com" :ref="i.com" :key="index" :title="i.tagName"></component>
                            <a @click.stop="handle(i.com, record.taskId)">{{ i.tagName }}</a>
                        </template>
...
const NEW_PROLIST = Object.freeze({ columns, data, proRecord })
