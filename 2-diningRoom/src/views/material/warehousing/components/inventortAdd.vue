...
<template>
  <j-modal :title="'库存管理'" :width="'1200px'" :visible="modalVisible" :maskClosable="false" @cancel="handleCancel">
    <!-- 主表单区域 -->
    <a-tabs default-active-key="1" v-if="!basicInfo1.id">
      <a-tab-pane key="1" tab="获取单号">
        <a-form :form="form1">
          <a-row :gutter="16">
            <a-col :span="6">
              <a-form-item label="申请人">
                <a-input
                  allowClear
                  v-decorator="['applicant', { rules: [{ required: true, message: '请输入!' }], initialValue: '王五' }]"
                ></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="6">
              <a-form-item label="采购名称">
                <a-input
                  ...
                  v-decorator="[
                    'headline',
                    { rules: [{ required: true, message: '请输入!' }], initialValue: '8月17日采购单1' }
                  ]"
                ></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="6">
              <a-form-item label="采购单号">
                <a-input
                  ...
                  v-decorator="[
                    'NUM',
                    { rules: [{ required: true, message: '请输入!' }], initialValue: 'ZZT20210817001' }
                  ]"
                ></a-input>
              </a-form-item>
            </a-col>
            ...
            <!-- <a-select
                  ...
                  v-decorator="[
                    'provider',
                    { rules: [{ required: true, message: '请选择!' }], initialValue: this.basicInfo1.provider }
                  ]"
                >
    ...
    <a-tabs default-active-key="1" v-else>
      <a-tab-pane key="1" tab="编辑库存">
        <j-editable-table ref="detailInfoForm" :columns="columns" :dataSource="dataSource1" :maxHeight="300">
          <template v-slot:materialName="props">
            <a-cascader
              :default-value="props.text.split('/')"
              :options="options"
...
export default {
  ...
  mounted() {
    ...
    if (!this.basicInfo1.headline)
      this.basicInfo1.headline = now.getMonth() + 1 + '月' + now.getDate() + '日食材申请清单'
