...
<template>
  <j-modal :title="'出库申请'" :width="'1200px'" :visible="modalVisible" :maskClosable="false" @cancel="handleCancel">
    <!-- 主表单区域 -->
            ...
            <a-col :span="6">
              <a-form-item label="申请名称">
                <a-input
                  ...
                  v-decorator="[
                    'headline',
                    { rules: [{ required: true, message: '请输入!' }], initialValue: this.basicInfo1.headline }
                  ]"
                ></a-input>
              </a-form-item>
            </a-col>
